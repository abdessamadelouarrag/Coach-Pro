...
<head>
    ...
    <script>
        tailwind.config = {
            theme: { extend: { colors: { brand: { orange: '#FF6B00', dark: '#0a0a0a', card: '#121212', gray: '#A1A1AA', surface: '#1E1E1E' } }, fontFamily: { sans: ['Poppins', 'sans-serif'] } } }
        }
    </script>
</head>
            ...
            <div class="bg-brand-card p-6 rounded-2xl border border-white/10">
                ...
                <form class="space-y-4">
                    <div class="flex justify-center mb-4 relative">
                        <img src="https://i.pravatar.cc/150?img=11" class="w-24 h-24 rounded-full border-4 border-brand-surface">
                        <div class="absolute bottom-0 right-1/4 bg-brand-orange p-1 rounded-full cursor-pointer hover:bg-orange-600">
                            <i data-lucide="camera" class="w-4 h-4 text-white"></i>
                        </div>
                    </div>
                    <div>
                        <label class="text-xs text-brand-gray">Nom Complet</label>
                        <input type="text" value="Jean Dupont" class="w-full bg-brand-surface p-2 rounded text-sm border border-white/5 focus:border-brand-orange outline-none">
                    </div>
                    <div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between bg-brand-surface p-4 rounded-xl border border-white/5">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-brand-gray">Demande: Lundi 14h - Cardio</p>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between bg-brand-surface p-4 rounded-xl border border-white/5">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="font-semibold text-sm">Lucas Durant</p>
                                <p class="text-xs text-brand-gray">Demande: Mardi 10h - Muscu</p>
                            </div>
                        </div>
                        <div class="flex gap-2">
                            <button class="p-2 bg-green-500/20 text-green-500 rounded hover:bg-green-500 hover:text-white transition"><i data-lucide="check" class="w-4 h-4"></i></button>
